...
<script type="text/ecmascript-6">
  ...
  export default {
    mixins:[playlistMixin],//共同的方法用mixin
    ...
    mounted(){
      ...
      this.minTrabslateY=-this.imageHeight+RESERVED_HEIGHT;
...
//      vuex提供的方法
    ...
    watch:{
      scrollY(newY){
        let tranlateY=Math.max(this.minTrabslateY,newY);
        let zIndex=0;
        let scale=1;
        let blur=0;
